...
/*
  ...
  for(int i=0; i<LED_COUNT; i++) { // For each pixel in strip...
    ...
    for(int i=0; i<LED_COUNT; i++) { // For each pixel in strip...
    strip.setPixelColor(i, 0, 255, 0, 0);         //  Set pixel's color (in RAM)
    strip.show();                          //  Update strip to match
    delay(10);                           //  Pause for a moment
  }

    for(int i=0; i<LED_COUNT; i++) { // For each pixel in strip...
    strip.setPixelColor(i, 0, 0, 255, 0);         //  Set pixel's color (in RAM)
    strip.show();                          //  Update strip to match
    delay(10);                           //  Pause for a moment
  }

    for(int i=0; i<LED_COUNT; i++) { // For each pixel in strip...
    strip.setPixelColor(i, 0, 0, 0, 240);         //  Set pixel's color (in RAM)
    strip.show();                          //  Update strip to match
    delay(10);                           //  Pause for a moment
  }
...
// for (int i=50; i<200; i++) { strip.setBrightness(i); strip.show(); delay(15); }
 //for (int i=200; i>50; i--) { strip.setBrightness(i); strip.show(); delay(15); }
